namespace MVC_MusicStoreApp.DAL.Migrations
{
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<MVC_MusicStoreApp.DAL.MusicStoreEntities>
    {
        ...
        protected override void Seed(MVC_MusicStoreApp.DAL.MusicStoreEntities context)
        {
            ...
            context.UserDetails.Add(new UserDetail { Address = "Istanbul", BirthDate = DateTime.Now, Email = "ata@ata.com", FirstName = "Ata", IsDeleted = false, IsLocked = false, LastName = "CCC", UserName = "admin", Password = "123", ConfirmPassword = "123", CreatedDate = DateTime.Now, Phone = "05386408232" });
            context.SaveChanges();
